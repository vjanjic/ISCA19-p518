...
\textbf{\textit{Communication-to-Computation Ratio:}}
...
\textbf{\textit{Number of Application Threads:}}
...
%Two additional workloads (Sync-3, Common-3) with 9 threads are also  marked as low number of application threads because the lower bound of threads number on $bodytrack$
